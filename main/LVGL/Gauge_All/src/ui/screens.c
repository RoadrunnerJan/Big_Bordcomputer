...
void create_screen_gauge_oil_pressure() {
    ...
    lv_obj_set_size(obj, 240, 240);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffff5a00), LV_PART_TICKS | LV_STATE_CHECKED);
        }
        {
...
void tick_screen_gauge_oil_pressure() {
    ...
    {
        const char *new_val = get_var_lvgl_value_oil_pressure();
...
void tick_screen_gauge_oil_temperature() {
    ...
    {
        const char *new_val = get_var_lvgl_value_oil_temperature();
